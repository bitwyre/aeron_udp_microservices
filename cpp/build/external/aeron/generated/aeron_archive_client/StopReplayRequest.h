...
public:
    ...
    {
        return *this = StopReplayRequest(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    StopReplayRequest &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = StopReplayRequest(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        StopReplayRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, StopReplayRequest &_writer)
{
