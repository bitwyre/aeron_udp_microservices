...
public:
    ...
    {
        return *this = BoundedReplayRequest(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    BoundedReplayRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = BoundedReplayRequest(
            buffer,
    ...
    BoundedReplayRequest &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = BoundedReplayRequest(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        BoundedReplayRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, BoundedReplayRequest &_writer)
{
