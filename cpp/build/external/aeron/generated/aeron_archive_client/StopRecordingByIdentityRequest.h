...
public:
    ...
    {
        return *this = StopRecordingByIdentityRequest(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    StopRecordingByIdentityRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = StopRecordingByIdentityRequest(
            buffer,
    ...
    StopRecordingByIdentityRequest &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = StopRecordingByIdentityRequest(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        StopRecordingByIdentityRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, StopRecordingByIdentityRequest &_writer)
{
