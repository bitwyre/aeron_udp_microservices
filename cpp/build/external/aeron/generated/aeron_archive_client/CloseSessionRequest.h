...
public:
    ...
    {
        return *this = CloseSessionRequest(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    CloseSessionRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = CloseSessionRequest(
            buffer,
    ...
    CloseSessionRequest &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = CloseSessionRequest(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        CloseSessionRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, CloseSessionRequest &_writer)
{
