...
public:
    ...
    {
        return *this = StopRecordingSubscriptionRequest(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    StopRecordingSubscriptionRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = StopRecordingSubscriptionRequest(
            buffer,
    ...
    StopRecordingSubscriptionRequest &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = StopRecordingSubscriptionRequest(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        StopRecordingSubscriptionRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, StopRecordingSubscriptionRequest &_writer)
{
