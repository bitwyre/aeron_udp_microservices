...
public:
    ...
    {
        return *this = AttachSegmentsRequest(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    AttachSegmentsRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = AttachSegmentsRequest(
            buffer,
    ...
    AttachSegmentsRequest &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = AttachSegmentsRequest(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        AttachSegmentsRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, AttachSegmentsRequest &_writer)
{
