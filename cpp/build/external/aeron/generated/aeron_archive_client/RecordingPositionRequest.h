...
public:
    ...
    {
        return *this = RecordingPositionRequest(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    RecordingPositionRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = RecordingPositionRequest(
            buffer,
    ...
    RecordingPositionRequest &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = RecordingPositionRequest(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        RecordingPositionRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, RecordingPositionRequest &_writer)
{
