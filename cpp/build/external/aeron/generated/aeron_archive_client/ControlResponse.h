...
public:
    ...
    {
        return *this = ControlResponse(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    ControlResponse &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = ControlResponse(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        ControlResponse skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, ControlResponse &_writer)
{
