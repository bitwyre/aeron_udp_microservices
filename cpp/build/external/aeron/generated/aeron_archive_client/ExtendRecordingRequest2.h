...
public:
    ...
    {
        return *this = ExtendRecordingRequest2(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    ExtendRecordingRequest2 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = ExtendRecordingRequest2(
            buffer,
    ...
    ExtendRecordingRequest2 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = ExtendRecordingRequest2(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        ExtendRecordingRequest2 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, ExtendRecordingRequest2 &_writer)
{
