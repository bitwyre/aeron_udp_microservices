...
public:
    ...
    {
        return *this = DetachSegmentsRequest(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    DetachSegmentsRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = DetachSegmentsRequest(
            buffer,
    ...
    DetachSegmentsRequest &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = DetachSegmentsRequest(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        DetachSegmentsRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, DetachSegmentsRequest &_writer)
{
