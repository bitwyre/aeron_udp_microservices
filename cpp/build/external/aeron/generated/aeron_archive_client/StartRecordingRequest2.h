...
public:
    ...
    {
        return *this = StartRecordingRequest2(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    StartRecordingRequest2 &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = StartRecordingRequest2(
            buffer,
    ...
    StartRecordingRequest2 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = StartRecordingRequest2(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        StartRecordingRequest2 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, StartRecordingRequest2 &_writer)
{
