...
public:
    ...
    {
        return *this = StartPositionRequest(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    StartPositionRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = StartPositionRequest(
            buffer,
    ...
    StartPositionRequest &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = StartPositionRequest(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        StartPositionRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, StartPositionRequest &_writer)
{
