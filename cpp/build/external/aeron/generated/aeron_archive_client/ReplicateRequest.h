...
public:
    ...
    {
        return *this = ReplicateRequest(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    ReplicateRequest &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = ReplicateRequest(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        ReplicateRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, ReplicateRequest &_writer)
{
