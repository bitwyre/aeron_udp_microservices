...
public:
    ...
    {
        return *this = ListRecordingSubscriptionsRequest(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    ListRecordingSubscriptionsRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = ListRecordingSubscriptionsRequest(
            buffer,
    ...
    ListRecordingSubscriptionsRequest &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = ListRecordingSubscriptionsRequest(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        ListRecordingSubscriptionsRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, ListRecordingSubscriptionsRequest &_writer)
{
