...
public:
    ...
    {
        return *this = FindLastMatchingRecordingRequest(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    FindLastMatchingRecordingRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = FindLastMatchingRecordingRequest(
            buffer,
    ...
    FindLastMatchingRecordingRequest &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = FindLastMatchingRecordingRequest(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        FindLastMatchingRecordingRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, FindLastMatchingRecordingRequest &_writer)
{
