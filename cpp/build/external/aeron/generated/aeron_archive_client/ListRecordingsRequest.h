...
public:
    ...
    {
        return *this = ListRecordingsRequest(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    ListRecordingsRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = ListRecordingsRequest(
            buffer,
    ...
    ListRecordingsRequest &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = ListRecordingsRequest(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        ListRecordingsRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, ListRecordingsRequest &_writer)
{
