...
public:
    ...
    {
        return *this = ExtendRecordingRequest(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    ExtendRecordingRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = ExtendRecordingRequest(
            buffer,
    ...
    ExtendRecordingRequest &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = ExtendRecordingRequest(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        ExtendRecordingRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, ExtendRecordingRequest &_writer)
{
