...
public:
    ...
    {
        return *this = StopRecordingRequest(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    StopRecordingRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = StopRecordingRequest(
            buffer,
    ...
    StopRecordingRequest &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = StopRecordingRequest(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        StopRecordingRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, StopRecordingRequest &_writer)
{
