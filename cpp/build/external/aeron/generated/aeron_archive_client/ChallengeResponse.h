...
public:
    ...
    {
        return *this = ChallengeResponse(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    ChallengeResponse &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = ChallengeResponse(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        ChallengeResponse skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, ChallengeResponse &_writer)
{
