...
public:
    ...
    {
        return *this = RecordingProgress(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    RecordingProgress &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = RecordingProgress(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        RecordingProgress skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, RecordingProgress &_writer)
{
