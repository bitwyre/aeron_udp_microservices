...
public:
    ...
    {
        return *this = ReplicateRequest2(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    ReplicateRequest2 &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = ReplicateRequest2(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        ReplicateRequest2 skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, ReplicateRequest2 &_writer)
{
