...
public:
    ...
    {
        return *this = MigrateSegmentsRequest(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    MigrateSegmentsRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = MigrateSegmentsRequest(
            buffer,
    ...
    MigrateSegmentsRequest &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = MigrateSegmentsRequest(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        MigrateSegmentsRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, MigrateSegmentsRequest &_writer)
{
