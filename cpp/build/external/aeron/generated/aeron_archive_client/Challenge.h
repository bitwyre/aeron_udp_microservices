...
public:
    ...
    {
        return *this = Challenge(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    Challenge &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = Challenge(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        Challenge skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, Challenge &_writer)
{
    Challenge writer(
        _writer.m_buffer,
        _writer.m_offset,
