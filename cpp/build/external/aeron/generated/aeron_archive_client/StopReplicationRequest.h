...
public:
    ...
    {
        return *this = StopReplicationRequest(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    StopReplicationRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = StopReplicationRequest(
            buffer,
    ...
    StopReplicationRequest &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = StopReplicationRequest(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        StopReplicationRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, StopReplicationRequest &_writer)
{
