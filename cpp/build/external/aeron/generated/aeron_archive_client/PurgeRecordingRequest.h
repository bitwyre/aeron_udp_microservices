...
public:
    ...
    {
        return *this = PurgeRecordingRequest(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    PurgeRecordingRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = PurgeRecordingRequest(
            buffer,
    ...
    PurgeRecordingRequest &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = PurgeRecordingRequest(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        PurgeRecordingRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, PurgeRecordingRequest &_writer)
{
