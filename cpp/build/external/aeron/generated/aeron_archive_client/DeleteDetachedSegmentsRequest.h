...
public:
    ...
    {
        return *this = DeleteDetachedSegmentsRequest(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    DeleteDetachedSegmentsRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = DeleteDetachedSegmentsRequest(
            buffer,
    ...
    DeleteDetachedSegmentsRequest &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = DeleteDetachedSegmentsRequest(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        DeleteDetachedSegmentsRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, DeleteDetachedSegmentsRequest &_writer)
{
