...
public:
    ...
    {
        return *this = ListRecordingsForUriRequest(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    ListRecordingsForUriRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = ListRecordingsForUriRequest(
            buffer,
    ...
    ListRecordingsForUriRequest &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = ListRecordingsForUriRequest(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        ListRecordingsForUriRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, ListRecordingsForUriRequest &_writer)
{
