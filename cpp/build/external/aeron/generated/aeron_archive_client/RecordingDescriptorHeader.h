...
public:
    ...
    {
        return *this = RecordingDescriptorHeader(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    RecordingDescriptorHeader &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = RecordingDescriptorHeader(
            buffer,
    ...
    RecordingDescriptorHeader &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = RecordingDescriptorHeader(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        RecordingDescriptorHeader skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, RecordingDescriptorHeader &_writer)
{
