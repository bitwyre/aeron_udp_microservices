...
public:
    ...
    {
        return *this = StopAllReplaysRequest(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    StopAllReplaysRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = StopAllReplaysRequest(
            buffer,
    ...
    StopAllReplaysRequest &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = StopAllReplaysRequest(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        StopAllReplaysRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, StopAllReplaysRequest &_writer)
{
