...
public:
    ...
    {
        return *this = KeepAliveRequest(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    KeepAliveRequest &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = KeepAliveRequest(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        KeepAliveRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, KeepAliveRequest &_writer)
{
