...
public:
    ...
    {
        return *this = PurgeSegmentsRequest(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    PurgeSegmentsRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = PurgeSegmentsRequest(
            buffer,
    ...
    PurgeSegmentsRequest &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = PurgeSegmentsRequest(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        PurgeSegmentsRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, PurgeSegmentsRequest &_writer)
{
