...
public:
    ...
    {
        return *this = StopPositionRequest(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    StopPositionRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = StopPositionRequest(
            buffer,
    ...
    StopPositionRequest &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = StopPositionRequest(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        StopPositionRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, StopPositionRequest &_writer)
{
