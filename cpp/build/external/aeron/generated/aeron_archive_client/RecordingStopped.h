...
public:
    ...
    {
        return *this = RecordingStopped(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    RecordingStopped &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = RecordingStopped(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        RecordingStopped skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, RecordingStopped &_writer)
{
