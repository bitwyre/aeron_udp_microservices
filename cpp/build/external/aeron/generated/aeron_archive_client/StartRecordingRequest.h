...
public:
    ...
    {
        return *this = StartRecordingRequest(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    StartRecordingRequest &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        ...
        return *this = StartRecordingRequest(
            buffer,
    ...
    StartRecordingRequest &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = StartRecordingRequest(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
    ...
    {
        StartRecordingRequest skipper(m_buffer, m_offset, m_bufferLength, sbeBlockLength(), m_actingVersion);
        skipper.skip();
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, StartRecordingRequest &_writer)
{
